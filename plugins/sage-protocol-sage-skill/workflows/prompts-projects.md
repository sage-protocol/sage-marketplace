...
- Run `sage library promote <library> --dao <dao> --auto --yes` to publish updates (personal DAOs auto-execute)
- Run `sage library promote <library> --dao <dao> --auto --yes` for community DAOs (creates proposal)
</quickstart>
...
sage library promote <library> --dao <dao> --auto --yes  # Personal DAO: auto-vote/execute
